...
const Warrior = () => {
  return (
    <>
      <span className='text-3xl font-bold px-14 mt-4'>
        Our CoachEd Warriors are
      </span>
      <div className='px-14 grid grid-cols-3 gap-10 pt-4 mb-10'>
        <div className='h-[250px] p-6 my-10 rounded-[10px] flex  justify-start flex-col items-start'>
          <div className='pb-4'>
      ...
      <div className='h-[80px] bg-[#ffffff] mx-14 rounded-[10px] relative flex justify-between items-center mb-10  my-10'>
        ...
        <div className='px-4 py-2 text-[#ffffff] fast-paced rounded-[10px]'>
          <div>Fast paced </div>
        </div>
      </div>
