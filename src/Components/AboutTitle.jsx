...
const AboutTitle = () => {
  return (
   ...
   <div>
     ...
     <span className='text-white text-2xl font-bold'>student their dream job </span>
   </div>
   <div className='py-4'>
     <span className='p-1 text-[#ffffff] text-2xl font-light'>
     and 
     </span>
     <span className='text-white text-2xl font-bold'>companies their perfect hire. </span>
   </div>
   </div>
